...
import 'package:olam_grains/widget/home/reported_events/specific_plant_events/details_page/near_miss_details_page.dart';
...
class SpecificPlantNearMissContainer extends StatelessWidget {
  SpecificPlantNearMissContainer({super.key});
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<QuerySnapshot>(
      stream: controller.firestore.collection("${loginController.dropDownValueForCountry}_${loginController.dropDownValueForPlant}").doc("${controller.nameController.text}_${controller.timeController.text}").collection('near_miss').orderBy('time_sent').snapshots(),
        ...
        if(snapshot.connectionState == ConnectionState.waiting) {
          ...
          return ListView.separated(
            ...
            itemBuilder: (context, index) {
              ...
              return InkWell(
                onTap: () {
                  Get.to(() => PlantNearMissDetailsPage(  //change this //////
