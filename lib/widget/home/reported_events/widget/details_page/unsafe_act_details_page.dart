...
class UnsafeActDetailsPage extends StatelessWidget {
  UnsafeActDetailsPage({super.key, required this.reporter, required this.eventLocation, required this.event, required this.eventDate, required this.eventTime, required this.eventPhoto, required this.plant, required this.country,});
