...
import 'package:olam_grains/widget/home/reported_events/widget/details_page/unsafe_condition_details_page.dart';





class UnSafeConditionContainer extends StatelessWidget {
  UnSafeConditionContainer({super.key});
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<QuerySnapshot>(
      stream: controller.firestore.collection('unsafe_condition').orderBy('time_sent').snapshots(),
        ...
        if(snapshot.connectionState == ConnectionState.waiting) {
          ...
          return ListView.separated(
            ...
            itemBuilder: (context, index) {
              ...
              return InkWell(
                onTap: () {
                  Get.to(() => UnsafeConditionDetailsPage(
