...
import 'package:olam_grains/widget/home/report_event/custom_date_picker/date_picker.dart';





class UnSafeAct extends StatefulWidget {
  UnSafeAct({super.key});

  @override
  State<UnSafeAct> createState() => _UnSafeActState();
}

class _UnSafeActState extends State<UnSafeAct> {

  final UnSafeActController controller = Get.put(UnSafeActController());
        ...
        children: <Widget>[
          ...
          SizedBox(
            ...
            child: ElevatedButton(
              ...
              onPressed: () {
                controller.saveDetailsToFirebase(context);
              },
              child: Text(
                'Submit',
                style: TextStyle(
